...
actual class CameraPositionState actual constructor(
    ...
    actual val projection: Projection? get() = null // PR3 limitation; PR4 wires this up
    ...
    actual suspend fun animate(update: CameraUpdate, durationMs: Int) {
        ...
        completion.await()
        // durationMs is honored only as "use SDK default" (default value of Int.MAX_VALUE).
        // Custom durations would require driving an interpolator ourselves; deferred to PR4.
    }
